...
public class ArrayExceptionDemo {
    ...
    // Helper method to take user input for array elements
    ...
    // Method to demonstrate the generation of an unhandled exception
    public static void generateException(String[] names) {
        ...
        // This line will cause the ArrayIndexOutOfBoundsException
        String name = names[names.length]; 
        System.out.println("This line will not be executed.");
    }

    // Method to demonstrate handling the exception using try-catch blocks
    ...
    public static void main(String[] args) {
        ...
        // Firstly, call the method that generates an unhandled exception
        // Note: The program will stop execution after this call unless run in a separate execution flow/commented out for the second part to run in sequence
        try {
        ...
        // Then, call the method that handles the runtime exception
